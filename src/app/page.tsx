      ...
      <section className={styles.socialSection}>
        ...
        <div className={styles.socialInner}>
          ...
          <div className={styles.socialCard}>
            ...
            <div className={styles.socialCardBody}>
              <div className={styles.socialCardAvatarRow}>
                ...
                <a href="https://x.com/akwaibomdesignsummit_" target="_blank" rel="noopener noreferrer" className={styles.socialFollowBtn}>Follow</a>
              </div>
          ...
          <div className={styles.socialPlatforms}>
            <a href="https://x.com/akwaibomdesignsummit_" target="_blank" rel="noopener noreferrer" className={styles.socialPlatformBtn}>
            ...
            <a href="https://instagram.com/akwaibomdesignsummit" target="_blank" rel="noopener noreferrer" className={styles.socialPlatformBtnBlue}>
